...
CREATE TABLE `solicitantes` (
  ...
  `nombresol` varchar(45) COLLATE utf8_spanish2_ci NOT NULL,
...
INSERT INTO `solicitantes` VALUES (1,'Solicitante 1','coreos1@correo.es',1),(2,'Solicitante 2','correos2@correo.es',1);
