...
CREATE TABLE `subcategorias` (
  ...
  `nombresubcat` varchar(45) COLLATE utf8_spanish2_ci NOT NULL,
  `Activo` tinyint(4) NOT NULL DEFAULT '1',
  PRIMARY KEY (`idsubcat`),
  KEY `caveajenacategoria_idx` (`idcat`),
  CONSTRAINT `caveajenacategoria` FOREIGN KEY (`idcat`) REFERENCES `categorias` (`idcat`)
